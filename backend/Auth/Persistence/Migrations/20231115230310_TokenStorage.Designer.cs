...
namespace Persistence.Migrations
{
    ...
    [Migration("20231115230310_TokenStorage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Persistence.Entity.Token", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("TokenStorage", "authorization");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Persistence.Entity.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Persistence.Entity.Token", b =>
                {
                    b.HasOne("Persistence.Entity.User", "User")
                        .WithMany("Tokens")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
